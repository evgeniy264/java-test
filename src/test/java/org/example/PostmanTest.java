...
public class PostmanTest {
    ...
    @Test
    @DisplayName("Тестирование запроса Get с параметрами")
    ...
    @Test
    @DisplayName("Тестирование запроса Post со строкой")
    ...
    @Test
    @DisplayName("Тестирование запроса Post с параметрами")
    ...
    @Test
    @DisplayName("Тестирование запроса Put со строкой")
